package dsd.microservices.product_service.util;
...
import dsd.microservices.product_service.response.data.DataResponseData;
import dsd.microservices.product_service.response.data.MessageResponseData;
